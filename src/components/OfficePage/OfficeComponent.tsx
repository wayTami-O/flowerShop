                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex gap-4 items-center">
                            <svg className="w-40 h-40" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M20 21.6667C24.6024 21.6667 28.3333 17.9357 28.3333 13.3333C28.3333 8.73096 24.6024 5 20 5C15.3976 5 11.6667 8.73096 11.6667 13.3333C11.6667 17.9357 15.3976 21.6667 20 21.6667Z" fill="#411528" stroke="#411528" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M33.3333 34.9993C33.3333 31.4631 31.9286 28.0717 29.4281 25.5713C26.9276 23.0708 23.5362 21.666 20 21.666C16.4638 21.666 13.0724 23.0708 10.5719 25.5713C8.07143 28.0717 6.66667 31.4631 6.66667 34.9993" stroke="#411528" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M20 21.666C16.4638 21.666 13.0724 23.0708 10.5719 25.5713C8.07143 28.0717 6.66667 31.4631 6.66667 34.9993H33.3333C33.3333 31.4631 31.9286 28.0717 29.4281 25.5713C26.9276 23.0708 23.5362 21.666 20 21.666Z" fill="#411528" stroke="#411528" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                ...
                <div className="w-958 flex flex-col gap-55 border-3 border-pink rounded-30 px-60 py-57">
                    ...
                    <div className="grid grid-cols-3 gap-x-70 gap-y-55">
                        <div className="mx-auto flex w-233 flex-col items-center justify-center border-1 border-rose rounded-20">
                            <img className="pt-2 w-137 h-155" src="/img/weekFlowers/weekFlower.png" alt="" />
