function PayMethods() {
    return (
        <>
            <div className="px-86 pt-111 flex gap-40">
                <div className="w-full h-244 flex flex-col gap-56 p-32 border-3 border-pink rounded-20">
                    <div className="flex justify-between">
                        <h2 className="font-bold font-mons text-36 text-kisses">Способ оплаты</h2>
                    ...
                    <p className="text-rose text-20 font-mons font-medium">Выбрать способ оплаты</p>
                </div>
                <div className="w-full h-244 flex flex-col gap-56 p-32 border-3 border-pink rounded-20">
                    <div className="flex justify-between">
                        <h2 className="font-bold font-mons text-36 text-kisses">Способ оплаты</h2>
