function Footer() {
    return (
        <footer className="flex justify-between h-482 pl-56 pr-36 pt-84 pb-25 mt-124 bg-ipkland">
            <div className="flex flex-col gap-76">
                ...
                <div className="flex flex-col gap-52">
                    <div className="flex items-center">
                        ...
                        <p className="text-36 font-medium text-transparent bg-clip-text bg-gradient-to-b from-a24c61 to-710c21">+7 777 777-77-77</p>
                    </div>
                    <div className="flex items-center gap-2">
                        ...
                        <p className="text-36 font-medium text-transparent bg-clip-text bg-gradient-to-b from-a24c61 to-710c21">example@example.com</p>
                    </div>
                </div>
            </div>
            <h2 className="mt-auto font-medium text-36 text-transparent bg-clip-text bg-gradient-to-b from-a24c61 to-710c21">© 2024 Fleur</h2>
        </footer>
    );
}
