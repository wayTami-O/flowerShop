                            ...
                            <div className="flex flex-col items-center gap-36">
                                <div className="flex flex-col gap-5 items-center justify-center">
                                    ...
                                    <div className="flex gap-2 items-center">
                                        ...
                                        {
                                            el.discount ? <p className="text-plum20 font-mons font-medium text-20 line-through">{el.oldPrice}</p>
                                            : null
                                        }
                                    </div>
                                </div>
                                    ...
                                    <Dialog>
                                        ...
                                        <DialogContent className="max-w-1556 h-835 !rounded-20 items-start justify-center">
                                            <DialogHeader className="relative w-1556 h-835 items-center gap-99">
                                                ...
                                                <img className="h-628 w-647" src={el.img} alt="" />
                                                <div className="w-759 flex flex-col items-center justify-center gap-140">
                                                    ...
                                                    <div className="flex flex-col items-center gap-48">
                                                        <h1 className="font-mons h-5 text-36 font-bold text-center text-kisses whitespace-nowrap">{el.title}</h1>
                                                            <div className="flex h-5 gap-2 items-center justify-center">
                                                                <p className="text-plum font-mons font-medium text-36">{el.price}</p>
                                                                {
                                                ...
                                                </div>
                                                {
                                                    el.discount ? 
                                                        (
                                                            <div className="h-48 w-111 flex items-center justify-center absolute left-529 top-95 rotate-28 bg-plum rounded-30 text-32 font-bold text-white">{el.discountValue}</div>
                                                        )
                                                    : null
                                                }
                                                {el.wishList ? (
